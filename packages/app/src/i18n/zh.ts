...
export const dict = {
  ...
  "store.notificationChannel.title": "通知渠道",
  "store.notificationChannel.description": "配置事件通知渠道。",
  "store.notificationChannel.empty": "暂无通知渠道配置。",
  "store.notificationChannel.enabled": "已启用",
  "store.notificationChannel.disabled": "已禁用",
  "store.notificationChannel.webhook": "Webhook 地址",
  "store.notificationChannel.events": "事件",
  "store.notificationChannel.edit": "编辑",
  "store.notificationChannel.delete": "删除",
  "store.notificationChannel.enable": "启用",
  "store.notificationChannel.disable": "禁用",
  "store.notificationChannel.confirmDelete": "确定删除此通知渠道？",
  "store.notificationChannel.toast.loadFailed": "加载通知渠道失败",
  "store.notificationChannel.toast.enabled": "渠道已启用",
  "store.notificationChannel.toast.disabled": "渠道已禁用",
  "store.notificationChannel.toast.toggleFailed": "切换渠道状态失败",
  "store.notificationChannel.toast.deleteSuccess": "渠道已删除",
  "store.notificationChannel.toast.deleteFailed": "删除渠道失败",

  "store.notificationChannelDialog.create.title": "创建通知渠道",
  "store.notificationChannelDialog.edit.title": "编辑通知渠道",
  "store.notificationChannelDialog.config": "配置",
  "store.notificationChannelDialog.configDescription": "配置您的企业微信 Webhook 通知。",
  "store.notificationChannelDialog.field.name": "渠道名称",
  "store.notificationChannelDialog.field.namePlaceholder": "我的渠道",
  "store.notificationChannelDialog.field.webhook": "Webhook 地址",
  "store.notificationChannelDialog.field.events": "通知事件",
  "store.notificationChannelDialog.field.eventsDescription": "选择需要接收通知的事件。",
  "store.notificationChannelDialog.error.nameRequired": "请输入渠道名称",
  "store.notificationChannelDialog.error.webhookRequired": "请输入 Webhook 地址",
  "store.notificationChannelDialog.error.eventsRequired": "请至少选择一个事件",
  "store.notificationChannelDialog.toast.created": "渠道已创建",
  "store.notificationChannelDialog.toast.createFailed": "创建渠道失败",
  "store.notificationChannelDialog.toast.updated": "渠道已更新",
  "store.notificationChannelDialog.toast.updateFailed": "更新渠道失败",
