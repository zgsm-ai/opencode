...
export const dict = {
  ...
  "prompt.change.title": "{{agent}} 需要先选择 change-id",
  "prompt.change.description": "请从 proposal/ 中选择一个 change-id 后自动启动任务，这里不允许自由输入文本。",
  "prompt.change.loading": "正在扫描 proposal/...",
  "prompt.change.select": "选择一个 change-id",
  "prompt.change.empty": "proposal/ 中未找到 change-id",
  "prompt.change.footer": "请选择 change-id 后启动",
  "prompt.change.starting": "正在启动 {{changeId}}...",
  "prompt.change.startingShort": "启动中...",
