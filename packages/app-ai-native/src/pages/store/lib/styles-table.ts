export const table = {
  tableShell: "relative min-h-[420px] overflow-hidden rounded-[0.875rem] border border-[color:color-mix(in_oklab,var(--native-border)_38%,transparent)] bg-[color:color-mix(in_oklab,var(--native-panel)_76%,var(--native-bg-subtle))] sm:min-h-[480px]",
  ...
  th: "h-auto whitespace-nowrap border-b border-[color:color-mix(in_oklab,var(--native-border)_34%,transparent)] px-3 py-[0.5625rem] text-left align-middle text-[11px] font-semibold uppercase tracking-[0.08em] text-[var(--native-muted)]",
  ...
  tshell: "overflow-hidden rounded-[var(--native-radius-md)] border border-[color:color-mix(in_oklab,var(--native-border)_38%,transparent)] bg-[color:color-mix(in_oklab,var(--native-panel)_76%,var(--native-bg-subtle))]",
