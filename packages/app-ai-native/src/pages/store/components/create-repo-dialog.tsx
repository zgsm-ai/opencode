    ...
    <form onSubmit={handleSubmit}>
      ...
      >
        <div class="store-modal-section">
          <div class="store-modal-section-title">{language.t("store.repoDialog.create.info")}</div>
          ...
          <div class="store-modal-row">
            ...
            <div class="store-modal-field" style={{ flex: "1" }}>
              ...
              <div class="store-modal-toggle-group">
                <button
                  type="button"
                  class={`store-modal-toggle ${store.repoType === "normal" ? "on" : ""}`}
                ...
                <button
                  type="button"
                  class={`store-modal-toggle ${store.repoType === "sync" ? "on" : ""}`}
