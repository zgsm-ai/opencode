...
export const dict = {
  ...
  "store.notificationChannels.add": "新增渠道",
  "store.notificationChannels.loading": "載入通知渠道中...",
  "store.notificationChannels.empty": "尚無通知渠道，點擊「新增渠道」建立企微機器人通知",
  "store.notificationChannels.enabled": "啟用",
  "store.notificationChannels.none": "無",
  "store.notificationChannels.test": "測試",
  "store.notificationChannels.testing": "測試中...",
  "store.notificationChannels.confirmDelete": "確定刪除渠道「{{name}}」嗎？",
  "store.notificationChannels.event.permission": "權限請求",
  "store.notificationChannels.event.question": "問卷提問",
  "store.notificationChannels.event.idle": "工作階段閒置",
  "store.notificationChannels.dialog.addTitle": "新增企微通知渠道",
  "store.notificationChannels.dialog.editTitle": "編輯企微通知渠道",
  "store.notificationChannels.dialog.name": "渠道名稱",
  "store.notificationChannels.dialog.namePlaceholder": "例：研發警報群機器人",
  ...
  "store.notificationChannels.dialog.confirmAdd": "確認新增",
  "store.notificationChannels.dialog.adding": "新增中...",
  "store.notificationChannels.dialog.error.nameRequired": "請填寫渠道名稱",
  "store.notificationChannels.dialog.error.webhookRequired": "請填寫 Webhook URL",
  "store.notificationChannels.toast.created": "通知渠道已建立",
  "store.notificationChannels.toast.createFailed": "通知渠道建立失敗",
  "store.notificationChannels.toast.updated": "通知渠道已更新",
  "store.notificationChannels.toast.updateFailed": "通知渠道更新失敗",
  "store.notificationChannels.toast.deleted": "通知渠道已刪除",
  "store.notificationChannels.toast.deleteFailed": "通知渠道刪除失敗",
  "store.notificationChannels.toast.testSent": "測試訊息已送出",
  "store.notificationChannels.toast.testSentDescription": "請查看企微機器人群是否收到訊息",
  "store.notificationChannels.toast.testFailed": "測試送出失敗",
