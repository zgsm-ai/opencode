...
export const dict = {
  ...
  // Cloud Team
  "cloudTeam.title": "云端团队",
  "cloudTeam.agentName": "云端团队",
  "cloudTeam.status.connected": "已连接",
  "cloudTeam.status.disconnected": "已断开",
  "cloudTeam.status.connecting": "连接中...",
  "cloudTeam.session.create": "新建会话",
  "cloudTeam.session.leave": "离开",
  "cloudTeam.session.title": "会话",
  "cloudTeam.teammates.label": "队友",
  "cloudTeam.teammates.online": "在线",
  "cloudTeam.teammates.busy": "忙碌",
  "cloudTeam.teammates.offline": "离线",
  "cloudTeam.tasks.label": "任务",
  "cloudTeam.tasks.completed": "已完成",
  "cloudTeam.tasks.pending": "待处理",
  "cloudTeam.tasks.assigned": "已分配",
  "cloudTeam.tasks.claimed": "已认领",
  "cloudTeam.tasks.running": "运行中",
  "cloudTeam.tasks.failed": "失败",
  "cloudTeam.tasks.noTasks": "暂无任务",
  "cloudTeam.approvals.label": "审批",
  "cloudTeam.approvals.pending": "待审批",
  "cloudTeam.approvals.approved": "已批准",
  "cloudTeam.approvals.rejected": "已拒绝",
  "cloudTeam.approvals.approve": "批准",
  "cloudTeam.approvals.reject": "拒绝",
  "cloudTeam.approvals.noApprovals": "暂无待审批",
  "cloudTeam.messages.label": "消息",
  "cloudTeam.messages.placeholder": "发送消息...",
  "cloudTeam.messages.send": "发送",
  "cloudTeam.messages.noMessages": "暂无消息",
  "cloudTeam.details.show": "详情",
  "cloudTeam.details.hide": "收起",
  "cloudTeam.toast.sessionCreated": "云端团队会话已创建",
  "cloudTeam.toast.sessionCreateFailed": "创建会话失败",
  "cloudTeam.toast.promptSent": "提示已提交到云端团队",
  "cloudTeam.toast.approvalResponded": "审批响应已发送",
