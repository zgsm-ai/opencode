...
export namespace Flag {
  ...
  // System Prompt control flags - 默认关闭以节省 tokens
  export const COSTRICT_DISABLE_ENVIRONMENT = true
  export const COSTRICT_DISABLE_CUSTOM_RULES = true
  export const COSTRICT_DISABLE_PLUGIN_HOOKS = true
  ...
  // System Prompt control flags - 默认关闭以节省 tokens
  export const OPENCODE_DISABLE_ENVIRONMENT = true
  export const OPENCODE_DISABLE_CUSTOM_RULES = true
  export const OPENCODE_DISABLE_PLUGIN_HOOKS = true
}
