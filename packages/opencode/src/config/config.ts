...
export namespace Config {
  ...
  export const Question = z.object({
    autoSelectFirstOption: z.boolean().optional(),
  })
  ...
  export const Info = z
    .object({
      ...
      promptLanguage: z.string().optional().describe("Preferred prompt language for builtin prompts and commands"),
      question: Question.optional().describe("Question/approval interaction settings"),
      ...
      snapshot: z
        .union([
          ...
          z.object({
            ...
            minFreeSpace: z.union([z.string(), z.number()]).optional(),
  ...
  export const global = lazy(() => getGlobal())
}
