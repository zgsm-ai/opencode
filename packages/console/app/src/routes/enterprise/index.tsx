...
export default function Enterprise() {
  ...
  return (
    <main data-page="enterprise">
      <Title>CoStrict | Enterprise solutions for your organisation</Title>
      <Link rel="canonical" href={`${config.baseUrl}/enterprise`} />
      <Meta name="description" content="Contact CoStrict for enterprise solutions" />
      <div data-component="container">
        ...
        <div data-component="content">
          <section data-component="enterprise-content">
            <div data-component="enterprise-columns">
              <div data-component="enterprise-column-1">
                ...
                <p>
                  CoStrict operates securely inside your organization with no data or context stored and no licensing
          ...
          <section data-component="faq">
            ...
            <ul>
              <li>
                <Faq question="What is CoStrict Enterprise?">
                  CoStrict Enterprise is for organizations that want to ensure that their code and data never leaves
                  their infrastructure. It can do this by using a centralized config that integrates with your SSO and
                  internal AI gateway.
                </Faq>
              </li>
              <li>
                <Faq question="How do I get started with CoStrict Enterprise?">
                  Simply start with an internal trial with your team. CoStrict by default does not store your code or
              ...
              <li>
                <Faq question="Is my data secure with CoStrict Enterprise?">
                  Yes. CoStrict does not store your code or context data. All processing happens locally or through
