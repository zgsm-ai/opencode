...
description: What's new in CoStrict 1.0.
---

CoStrict 1.0 is a complete rewrite of the TUI.
...
The new TUI works like the old one since it connects to the same costrict-cli server.
...
version. However some older versions of CoStrict always grab latest.

To upgrade manually, run

```bash
$ costrict-cli upgrade 1.0.0
```

To downgrade back to 0.x, run

```bash
$ costrict-cli upgrade 0.15.31
```
