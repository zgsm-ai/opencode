...
For TUI-specific settings, use `~/.config/costrict-cli/tui.json`.
...
TUI config uses [**`costrict.ai/tui.json`**](https://costrict.ai/tui.json).
...
You can also place TUI-specific theme settings in `tui.json`.
