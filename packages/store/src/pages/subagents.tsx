...
export default function Subagents() {
  ...
  const { items: orgItems, loading: orgLoading } = useOrgItems(selectedOrg, "subagent")
    ...
    <div class="px-8 py-8">
      <div class="mb-8">
        <h1 class="text-2xl font-semibold mb-1 flex items-center gap-2.5 text-text-strong">
          <span class="text-blue-500">⬡</span> Subagents
        </h1>
        <p class="text-sm text-text-weak">{total()} subagents</p>
      </div>
